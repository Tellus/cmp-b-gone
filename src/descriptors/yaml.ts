...
export class YamlDescriptor extends SimpleCMPDescriptor {
  ...
  static async createFromPath(path: string, encoding: BufferEncoding = 'utf8'): Promise<YamlDescriptor> {
  ...
  static createFromPathSync(path: string, encoding: BufferEncoding = 'utf8'): YamlDescriptor {
